        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild>
              <button className="text-lg font-medium flex items-center gap-2 cursor-pointer">
                <span>Cart</span>
                {cartItems.length > 0 && (
                  <span className="inline-flex items-center justify-center w-5 text-xs font-medium bg-black text-white rounded-full">
                    {cartItems.reduce(
